...
public class VirtualPropertyTotalPages {
	static String here = new File("../Resources").getAbsolutePath();
	  ...
	  public static void main(String[] args) throws IOException {
	    ...
	    EPackage Publ = (EPackage) resSet.getResource(resourceURI("/metamodels/Basic/Publication.ecore"), true).getContents().get(0);
	    ...
	    Resource publ = resSet.getResource(resourceURI("/models/Basic/Publication.xmi"), true);
	    ...
	    ConcreteConcept concreteConceptPublication;
	    {
...

	    {
	      ...
	      vAssociation.setSource(concreteConceptPublication);
	    ...
	    VirtualProperty pubTotalPages;
	    {
		  ...
		  vProperty.setParent(concreteConceptPublication);
		  pubTotalPages = vProperty;
	    }
...

	    {
	      ...
	      va.setSource(concreteConceptPublication);
	      va.setTarget(target);
	    }
