...
public class VirtualConceptEx {
  ...
  public static void main(String[] args) {
    ...
    viewpointWeavingModel.setName("virtualConceptEx");
    ...
    VirtualConcept person;
    {
        ...
        contributingModel.setURI("http://publication");
        VirtualConcept vConcept = vLinksFactory.createVirtualConcept();
        vConcept.setName("Person");
        person = vConcept;
    }
