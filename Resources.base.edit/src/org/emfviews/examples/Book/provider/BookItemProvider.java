...
/**
 * This is the item provider adapter for a {@link org.emfviews.examples.Book.Book} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class BookItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 BookPackage.Literals.BOOK__TITLE,
				 true,
				 false,
				 false,
	...
	protected void addAuthorNamePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Book_authorName_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Book_authorName_feature", "_UI_Book_type"),
				 BookPackage.Literals.BOOK__AUTHOR_NAME,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 BookPackage.Literals.BOOK__ISBN,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(BookPackage.Literals.BOOK__CHAPTERS);
		}
	...
	public String getText(Object object) {
		String label = ((Book)object).getAuthorName();
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(BookPackage.Literals.BOOK__CHAPTERS,
				 BookFactory.eINSTANCE.createChapter()));
	}
